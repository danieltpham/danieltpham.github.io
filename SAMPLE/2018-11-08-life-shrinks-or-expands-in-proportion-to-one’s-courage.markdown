...
template: image-left # You can specify the position of the image. For example: image-left, image-right, image-center
accent: '#5730d8' # To change the accent color, add a hexadecimal color code (HEX). For example - '#5b2c6f'
image:  '/images/07.jpg'
tags:   [work]
---
...
![Car]({{site.baseurl}}/images/03-1.jpg#wide)
*Photo by [Benjamin Child](https://unsplash.com/photos/7Cdw956mZ4w) on [Unsplash](https://unsplash.com/)*
...
![Car]({{site.baseurl}}/images/03-2.jpg)
*Photo by [Stefan Rodriguez](https://unsplash.com/photos/2AovfzYV3rc) on [Unsplash](https://unsplash.com/)*
