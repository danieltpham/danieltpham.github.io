...
accent: '#2986db' # To change the accent color, add a hexadecimal color code (HEX). For example - '#5b2c6f'
image:  '/images/09.jpg'
tags:   [technology]
featured: true
---
...
![Forest]({{site.baseurl}}/images/05-1.jpg#wide)
*Photo by [Geran de Klerk](https://unsplash.com/photos/WJkc3xZjSXw) on [Unsplash](https://unsplash.com/)*
...
![Drone]({{site.baseurl}}/images/05-2.jpg)
*Photo by [Aaron Burden](https://unsplash.com/photos/28ydDnpskh0) on [Unsplash](https://unsplash.com/)*
