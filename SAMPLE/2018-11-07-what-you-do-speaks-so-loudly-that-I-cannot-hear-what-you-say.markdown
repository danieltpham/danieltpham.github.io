...
template: image-center # You can specify the position of the image. For example: image-left, image-right, image-center
accent: '#de3d77' # To change the accent color, add a hexadecimal color code (HEX). For example - '#5b2c6f'
image:  '/images/08.jpg'
tags:   [travel]
featured: true
---
...
![Photographer]({{site.baseurl}}/images/08-1.jpg#wide)
*Photo by [Benjamin Combs](https://unsplash.com/photos/ag51iExrb0U) on [Unsplash](https://unsplash.com/)*
...
![Rest]({{site.baseurl}}/images/08-2.jpg)
*Photo by [Jimmy Conover](https://unsplash.com/photos/J_XuXX9m0KM) on [Unsplash](https://unsplash.com/)*
