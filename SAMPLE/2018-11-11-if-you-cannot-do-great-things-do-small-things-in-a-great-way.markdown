...
accent: '#6123E4' # To change the accent color, add a hexadecimal color code (HEX). For example - '#5b2c6f'
image:  '/images/04.jpg'
tags:   [work]
featured: true
---
...
*Photo by [Annie Spratt](https://unsplash.com/photos/DYROsn8AyDI) on [Unsplash](https://unsplash.com/)*
...
*Photo by [Matheus Ferrero](https://unsplash.com/photos/4QotHf68gSg) on [Unsplash](https://unsplash.com/)*
