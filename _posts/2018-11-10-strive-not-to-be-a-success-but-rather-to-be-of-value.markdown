...
accent: '#de725a' # To change the accent color, add a hexadecimal color code (HEX). For example - '#5b2c6f'
image:  '/images/05.jpg'
tags:   [motivation]
---
...
*Photo by [All Bong](https://unsplash.com/photos/JDN-_FIqB3k) on [Unsplash](https://unsplash.com/)*
...
![House]({{site.baseurl}}/images/09-2.jpg)
*Photo by [Daria Nepriakhina](https://unsplash.com/photos/zNU3ErDAbAw) on [Unsplash](https://unsplash.com/)*
